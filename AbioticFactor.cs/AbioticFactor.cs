...
namespace WindowsGSM.Plugins
{
    public class AbioticFactor : SteamCMDAgent
    {
        ...
        public Plugin Plugin = new Plugin
        {
            ...
            author = "Kavex",
            description = "WindowsGSM plugin for supporting Abiotic Factor Dedicated Server",
            version = "1.0",
            url = "https://github.com/Kavex/WindowsGSM.AbioticFactor", // Github repository link (Best practice)
        ...
        // Latest Main Release
        public override string AppId => "2857200"; // Game server appId Steam
        ...
        public string FullName = "Abiotic Factor Dedicated Server"; // Game server FullName
        ...
        public string Additional = "-ServerPassword=CHANGEME -SteamServerName='Abiotic Factor Dedicated Server'"; // Additional server start parameter
        ...
        public async Task<Process> Start()
        {
            ...
            string param = "AbioticFactorServer -log -useperfthreads -NoAsyncLoadingThread -unattended";
            ...
            param += string.IsNullOrWhiteSpace(_serverData.ServerMaxPlayer) ? string.Empty : $" -MaxServerPlayers={_serverData.ServerMaxPlayer}";
